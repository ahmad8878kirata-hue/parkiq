...
import { X, CaretLeft, CaretRight, Minus, Plus, MapPin } from '@phosphor-icons/react';
import './Search.css';
            ...
            <div className="sheet-content">
                ...
                <div className="mb-4">
                    ...
                    <input 
                        ...
                        autoFocus
                        style={{width: '100%', padding: '1rem', borderRadius: 'var(--radius-md)', border: '1.5px solid var(--primary-light)', outline: 'none', fontFamily: 'var(--font-body)', fontSize: '1rem', background: '#fff', boxShadow: '0 4px 12px rgba(244, 63, 94, 0.1)'}}
                    />
                </div>
